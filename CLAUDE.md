...
src/
  ...
  Rendering
    render.h/c      — Block/inline markdown rendering to ncurses, preview buffer construction
    render_table.h/c — Pipe-table detection, column-width computation, ACS box-drawing
...
- Write unit tests for new pure-logic functions (anything not needing ncurses).
